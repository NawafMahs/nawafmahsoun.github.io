...
`,e.jsx(n.pre,{className:"language-csharp",children:e.jsxs(n.code,{className:"language-csharp",children:[e.jsx(n.span,{className:"token class-name",children:e.jsx(n.span,{className:"token keyword",children:"int"})})," number ",e.jsx(n.span,{className:"token operator",children:"="})," ",e.jsx(n.span,{className:"token number",children:"42"}),e.jsx(n.span,{className:"token punctuation",children:";"}),`\r
\r
`,e.jsx(n.span,{className:"token comment",children:"// Boxing 🔄"}),`\r
`,e.jsx(n.span,{className:"token class-name",children:e.jsx(n.span,{className:"token keyword",children:"object"})})," boxedNumber ",e.jsx(n.span,{className:"token operator",children:"="})," number",e.jsx(n.span,{className:"token punctuation",children:";"})," ",e.jsx(n.span,{className:"token comment",children:"// Value → Reference (involves memory overhead!)"}),`\r
\r
`,e.jsx(n.span,{className:"token comment",children:"// Unboxing 🔄"}),`\r
