...
const title = 'Developed a comprehensive web platform for Karman Trading Company';
const description = 'Developed a comprehensive web platform for Karman Trading Company, a leading enterprise in Korea and Dubai specializing in cars, spare parts, half cuts, and more.';
const roles = [
  'Art Direction',
  'UX and UI Design',
