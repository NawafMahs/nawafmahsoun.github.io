...
const sprites = "/assets/icons-CO_AdM8X.svg";
...
const url$1 = "https://bd394417.portfolio-7ag.pages.dev/";
const LinkedIn = "NawafMahsoun";
const github = "NawafMahs";
const repo = "https://github.com/NawafMahs/nawafmahsoun.github.io ";
    ...
    children: [jsxs(_components.p, {
      ...
      children: jsxs(_components.code, {
        ...
        children: [jsx(_components.span, {
          ...
          className: "token operator",
          children: "<"
        }), "button className", jsx(_components.span, {
          className: "token operator",
          children: "="
        }), jsx(_components.span, {
          className: "token string",
          children: '"button"'
        }), " style", jsx(_components.span, {
          className: "token operator",
          children: "="
        }), jsx(_components.span, {
          className: "token punctuation",
...
const Carousel = lazy(
  () => import("./index-CakbrB-a.js").then((module) => ({ default: module.Carousel }))
);
const Armor = lazy(() => import("./armor-B5Fr1ucI.js").then((module) => ({ default: module.Armor })));
...
const Earth = lazy(() => import("./earth-CSdARYCB.js").then((module) => ({ default: module.Earth })));
const EarthSection = lazy(
  () => import("./earth-CSdARYCB.js").then((module) => ({ default: module.EarthSection }))
);
const title$5 = "Developed a comprehensive web platform for Karman Trading Company";
const description$3 = "Developed a comprehensive web platform for Karman Trading Company, a leading enterprise in Korea and Dubai specializing in cars, spare parts, half cuts, and more.";
const roles$1 = [
  "Art Direction",
  "UX and UI Design",
...
function _createMdxContent(props) {
  ...
  return jsxs(Fragment$1, {
    children: [jsx(_components.h2, {
      id: "-exploring-the-dynamics-of-boxing-and-unboxing-in-net-development-",
      children: "🚀 Exploring the Dynamics of Boxing and Unboxing in .NET Development 🥊📦"
    }), "\n", jsx(_components.p, {
      children: "In my .NET journey, I've delved into the nuanced realm of boxing and unboxing, where attention to detail can significantly impact performance. These concepts have been instrumental in teaching me the delicate balance between convenience and efficiency."
    }), "\n", jsx(_components.h3, {
      ...
      children: ["\n", jsxs(_components.li, {
        children: [jsx(_components.strong, {
          children: "Boxing 📦"
        }), " involves encapsulating a value type (e.g., int, struct) within a reference type (object)."]
      }), "\n", jsxs(_components.li, {
        children: [jsx(_components.strong, {
          children: "Unboxing 🥊"
        }), ", on the other hand, is the process of extracting that original value type."]
      }), "\n"]
    }), "\n", jsx(_components.h3, {
      id: "why-does-it-matter",
      children: "Why does it matter?"
    }), "\n", jsx(_components.p, {
      children: "Each boxing and unboxing operation introduces overhead, akin to sending yourself a letter just to open it later! 💌"
    }), "\n", jsx(_components.h3, {
      id: "-lets-illustrate-with-an-example",
      ...
      children: jsxs(_components.code, {
        ...
        children: [jsx(_components.span, {
        ...
        }), " boxedNumber ", jsx(_components.span, {
          className: "token operator",
          children: "="
        }), " number", jsx(_components.span, {
          className: "token punctuation",
          ...
          className: "token comment",
          children: "// Value → Reference (involves memory overhead!)"
        }), "\n\n", jsx(_components.span, {
          className: "token comment",
          children: "// Unboxing 🔄"
        }), "\n", jsx(_components.span, {
        ...
        }), " unboxedNumber ", jsx(_components.span, {
          className: "token operator",
          children: "="
        }), " ", jsx(_components.span, {
          className: "token punctuation",
          ...
          className: "token comment",
          children: "// Reference → Value (requires explicit cast!)"
        }), "\n"]
      })
    }), "\n", jsx(_components.h3, {
      id: "️-caution",
      ...
      children: ["Incorrect unboxing, such as mismatched types, can lead to ", jsx(_components.code, {
        children: "InvalidCastException"
      }), ". Validation is key!"]
    }), "\n", jsx(_components.h3, {
      id: "-expert-insight",
      children: "💡 Expert Insight:"
    }), "\n", jsxs(_components.p, {
      children: ["To enhance performance in critical code segments, steer clear of unnecessary boxing. Opt for generics (e.g., ", jsx(_components.code, {
        children: "List<int>"
      }), " over ", jsx(_components.code, {
        children: "ArrayList"
      ...
      children: "Have you navigated through boxing/unboxing challenges? Or perhaps you possess optimization tips? Join the conversation below! 👇"
    })]
  });
}
...
async function getPosts() {
  ...
  const posts = await Promise.all(
    Object.entries(modules).map(async ([file, post2]) => {
      ...
      const text2 = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../articles.hello-world.mdx": () => import("./articles.hello-world-CkL2_W0v.js"), "../articles.modern-styling-in-react.mdx": () => import("./articles.modern-styling-in-react-gVTsmSoG.js") }), `../articles.${slug}.mdx`, 2);
...
const karmanPlatform = "/assets/karman-platform-MHQTIKNv.jpg";
const selaPlatform = "/assets/sela-platform-C9M9JuXw.jpg";
function subscribe() {
  return () => {
  };
}
...
const DisplacementSphere = lazy(
  () => import("./displacement-sphere-C_5yl87z.js").then((module) => ({ default: module.DisplacementSphere }))
);
...
const newProfileImg = "/assets/new-profile-TjPvo9z6.jpg";
...
const ProfileText = ({ visible, titleId }) => /* @__PURE__ */ jsxs(Fragment, { children: [
  ...
  /* @__PURE__ */ jsx(Text, { className: styles$4.description, "data-visible": visible, size: "l", as: "p", children: "I'm Nawaf, a .NET Developer based in Syria with a passion for building robust and scalable applications. My expertise lies in ASP.NET Core, Blazor, and Clean Architecture, where I focus on creating efficient solutions that drive business growth." }),
  /* @__PURE__ */ jsx(Text, { className: styles$4.description, "data-visible": visible, size: "l", as: "p", children: "With over two years of experience, I specialize in developing high-performance web applications using modern .NET technologies. I'm Microsoft-certified in C# and experienced in full-stack development, always striving to deliver clean, maintainable code following SOLID principles." }),
  /* @__PURE__ */ jsx(Text, { className: styles$4.description, "data-visible": visible, size: "l", as: "p", children: "When I'm not coding, I enjoy exploring new technologies and contributing to open-source projects. Feel free to reach out if you'd like to discuss potential collaborations or opportunities." })
] });
          ...
          /* @__PURE__ */ jsxs("div", { className: styles$4.image, children: [
            /* @__PURE__ */ jsx(
              Image$1,
              {
                ...
                srcSet: `${newProfileImg} 480w, ${newProfileImg} 960w`,
                width: 960,
                height: 1280,
                sizes: `(max-width: ${media.mobile}px) 100vw, 480px`,
                alt: "Profile picture of Nawaf Mahsoun"
              }
            ),
...
const Model = lazy(
  () => import("./index-Bwc6XBG0.js").then((module) => ({ default: module.Model }))
);
...
const meta$2 = () => {
  return baseMeta({
    ...
    description: `Portfolio of ${config.name} — a .NET Developer specializing in ASP.NET Core, Blazor, and Clean Architecture, with expertise in building scalable web applications and robust software solutions.`
  });
};
const Home = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: styles$2.home, children: [
    ...
    /* @__PURE__ */ jsx(
      ProjectSummary,
      {
        ...
        index: 1,
        title: "Developed a comprehensive web platform for Karman Trading Company",
        description: "Developed a comprehensive web platform for Karman Trading Company, a leading enterprise in Korea and Dubai specializing in cars, spare parts, half cuts, and more.",
        buttonText: "View project",
        buttonLink: "http://karmanttrading.runasp.net/",
        model: {
          type: "laptop",
          alt: "Karman Trading Company platform",
          textures: [
            {
              srcSet: `${karmanPlatform} 1280w, ${karmanPlatform} 2560w`,
              placeholder: karmanPlatform
            }
          ]
        }
      }
    ...
    /* @__PURE__ */ jsx(
      ProjectSummary,
      {
        ...
        index: 2,
        title: "Developed a comprehensive web platform for Real Estate",
        description: "Design and development for a Real Estate website built in Blazor, enhancing property management and client engagement with modern web technologies.",
        buttonText: "View project",
        buttonLink: "http://sela.runasp.net/",
        model: {
          type: "laptop",
          alt: "Real Estate platform",
          textures: [
            {
              srcSet: `${selaPlatform} 375w, ${selaPlatform} 750w`,
              placeholder: selaPlatform
            }
          ]
        }
      }
...
const serverManifest = { "entry": { "module": "/assets/entry.client-ClrB1oeU.js", "imports": ["/assets/jsx-runtime-e9svsKL-.js", "/assets/components-C18L6ojx.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/root-Bnu5UsIA.js", "imports": ["/assets/jsx-runtime-e9svsKL-.js", "/assets/components-C18L6ojx.js", "/assets/image-CH7BK92V.js", "/assets/error-yYWAaizB.js", "/assets/visually-hidden-y2O2nUag.js", "/assets/heading-Dsf1s-Cf.js", "/assets/useScrollToHash-C31C6Ygo.js", "/assets/useWindowSize-BaU--EEd.js", "/assets/config-BuEQexaM.js", "/assets/decoder-text-BYPAtVqV.js", "/assets/use-spring-9URyKdiH.js", "/assets/index-tPt4D6iO.js"], "css": ["/assets/root-AirrcxGX.css", "/assets/image-Db9mAJ2F.css", "/assets/heading-UwcgqAqE.css", "/assets/error-BT7XG2_u.css", "/assets/decoder-text-9RaPT1ab.css", "/assets/visually-hidden-BpS8kiyk.css"] }, "routes/articles.modern-styling-in-react": { "id": "routes/articles.modern-styling-in-react", "parentId": "routes/articles", "path": "modern-styling-in-react", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/articles.modern-styling-in-react-vxwd248f.js", "imports": ["/assets/jsx-runtime-e9svsKL-.js", "/assets/index-g-YDB1ab.js"], "css": [] }, "routes/projects.volkihar-knight": { "id": "routes/projects.volkihar-knight", "parentId": "root", "path": "projects/volkihar-knight", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-DHqbCu-N.js", "imports": ["/assets/preload-helper-D7HrI6pR.js", "/assets/jsx-runtime-e9svsKL-.js", "/assets/heading-Dsf1s-Cf.js", "/assets/meta-wLrhBEuU.js", "/assets/image-CH7BK92V.js", "/assets/project-sYNNwrmq.js", "/assets/components-C18L6ojx.js", "/assets/config-BuEQexaM.js", "/assets/useParallax-C0lR-2-7.js"], "css": ["/assets/route-TU9yO5A9.css", "/assets/heading-UwcgqAqE.css", "/assets/meta-DdulKb1r.css", "/assets/image-Db9mAJ2F.css", "/assets/project-C8oXv4p4.css"] }, "routes/projects.smart-sparrow": { "id": "routes/projects.smart-sparrow", "parentId": "root", "path": "projects/smart-sparrow", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-PjMU3cYv.js", "imports": ["/assets/preload-helper-D7HrI6pR.js", "/assets/jsx-runtime-e9svsKL-.js", "/assets/meta-wLrhBEuU.js", "/assets/image-CH7BK92V.js", "/assets/visually-hidden-y2O2nUag.js", "/assets/heading-Dsf1s-Cf.js", "/assets/project-sYNNwrmq.js", "/assets/components-C18L6ojx.js", "/assets/config-BuEQexaM.js", "/assets/useParallax-C0lR-2-7.js"], "css": ["/assets/route-CwDSZRuz.css", "/assets/meta-DdulKb1r.css", "/assets/heading-UwcgqAqE.css", "/assets/image-Db9mAJ2F.css", "/assets/visually-hidden-BpS8kiyk.css", "/assets/project-C8oXv4p4.css"] }, "routes/articles.hello-world": { "id": "routes/articles.hello-world", "parentId": "routes/articles", "path": "hello-world", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/articles.hello-world-BI3xeATP.js", "imports": ["/assets/jsx-runtime-e9svsKL-.js", "/assets/index-g-YDB1ab.js"], "css": [] }, "routes/articles_._index": { "id": "routes/articles_._index", "parentId": "root", "path": "articles", "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-_dq0wZWh.js", "imports": ["/assets/meta-wLrhBEuU.js", "/assets/jsx-runtime-e9svsKL-.js", "/assets/heading-Dsf1s-Cf.js", "/assets/decoder-text-BYPAtVqV.js", "/assets/divider-CwASCwMq.js", "/assets/image-CH7BK92V.js", "/assets/useWindowSize-BaU--EEd.js", "/assets/date-DvyCAN0s.js", "/assets/components-C18L6ojx.js", "/assets/config-BuEQexaM.js", "/assets/visually-hidden-y2O2nUag.js", "/assets/use-spring-9URyKdiH.js", "/assets/index-tPt4D6iO.js"], "css": ["/assets/route-2ahMLohn.css", "/assets/meta-DdulKb1r.css", "/assets/heading-UwcgqAqE.css", "/assets/decoder-text-9RaPT1ab.css", "/assets/visually-hidden-BpS8kiyk.css", "/assets/divider-RCNywGVV.css", "/assets/image-Db9mAJ2F.css"] }, "routes/projects.slice": { "id": "routes/projects.slice", "parentId": "root", "path": "projects/slice", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-DezpjDLy.js", "imports": ["/assets/jsx-runtime-e9svsKL-.js", "/assets/slice-app-C7u_2Rr3.js", "/assets/meta-wLrhBEuU.js", "/assets/image-CH7BK92V.js", "/assets/project-sYNNwrmq.js", "/assets/heading-Dsf1s-Cf.js", "/assets/components-C18L6ojx.js", "/assets/config-BuEQexaM.js", "/assets/useParallax-C0lR-2-7.js"], "css": ["/assets/route-DBxCm94u.css", "/assets/meta-DdulKb1r.css", "/assets/heading-UwcgqAqE.css", "/assets/image-Db9mAJ2F.css", "/assets/project-C8oXv4p4.css"] }, "routes/api.set-theme": { "id": "routes/api.set-theme", "parentId": "root", "path": "api/set-theme", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/api.set-theme-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/articles": { "id": "routes/articles", "parentId": "root", "path": "articles", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-cFfFfoyk.js", "imports": ["/assets/jsx-runtime-e9svsKL-.js", "/assets/divider-CwASCwMq.js", "/assets/meta-wLrhBEuU.js", "/assets/heading-Dsf1s-Cf.js", "/assets/image-CH7BK92V.js", "/assets/useParallax-C0lR-2-7.js", "/assets/useScrollToHash-C31C6Ygo.js", "/assets/clamp-e7DugykH.js", "/assets/date-DvyCAN0s.js", "/assets/components-C18L6ojx.js", "/assets/list-iN0c2GQH.js", "/assets/index-g-YDB1ab.js", "/assets/config-BuEQexaM.js"], "css": ["/assets/route-C-22_ukK.css", "/assets/divider-RCNywGVV.css", "/assets/heading-UwcgqAqE.css", "/assets/meta-DdulKb1r.css", "/assets/image-Db9mAJ2F.css", "/assets/list-A5E2UkK_.css"] }, "routes/contact": { "id": "routes/contact", "parentId": "root", "path": "contact", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-CSi9wEq5.js", "imports": ["/assets/jsx-runtime-e9svsKL-.js", "/assets/heading-Dsf1s-Cf.js", "/assets/decoder-text-BYPAtVqV.js", "/assets/divider-CwASCwMq.js", "/assets/meta-wLrhBEuU.js", "/assets/components-C18L6ojx.js", "/assets/visually-hidden-y2O2nUag.js", "/assets/use-spring-9URyKdiH.js", "/assets/index-tPt4D6iO.js", "/assets/config-BuEQexaM.js"], "css": ["/assets/route-DUdvKm6g.css", "/assets/heading-UwcgqAqE.css", "/assets/decoder-text-9RaPT1ab.css", "/assets/visually-hidden-BpS8kiyk.css", "/assets/divider-RCNywGVV.css", "/assets/meta-DdulKb1r.css"] }, "routes/home": { "id": "routes/home", "parentId": "root", "path": "home", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-1hSRzWWB.js", "imports": ["/assets/route-zL8O1YgO.js", "/assets/jsx-runtime-e9svsKL-.js", "/assets/slice-app-C7u_2Rr3.js", "/assets/meta-wLrhBEuU.js", "/assets/heading-Dsf1s-Cf.js", "/assets/components-C18L6ojx.js", "/assets/config-BuEQexaM.js", "/assets/preload-helper-D7HrI6pR.js", "/assets/decoder-text-BYPAtVqV.js", "/assets/visually-hidden-y2O2nUag.js", "/assets/use-spring-9URyKdiH.js", "/assets/index-tPt4D6iO.js", "/assets/image-CH7BK92V.js", "/assets/useScrollToHash-C31C6Ygo.js", "/assets/divider-CwASCwMq.js", "/assets/useWindowSize-BaU--EEd.js"], "css": ["/assets/route-B21ryf_9.css", "/assets/meta-DdulKb1r.css", "/assets/heading-UwcgqAqE.css", "/assets/decoder-text-9RaPT1ab.css", "/assets/visually-hidden-BpS8kiyk.css", "/assets/image-Db9mAJ2F.css", "/assets/divider-RCNywGVV.css"] }, "routes/uses": { "id": "routes/uses", "parentId": "root", "path": "uses", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-B19m7wyj.js", "imports": ["/assets/jsx-runtime-e9svsKL-.js", "/assets/meta-wLrhBEuU.js", "/assets/list-iN0c2GQH.js", "/assets/project-sYNNwrmq.js", "/assets/heading-Dsf1s-Cf.js", "/assets/components-C18L6ojx.js", "/assets/config-BuEQexaM.js", "/assets/image-CH7BK92V.js", "/assets/useParallax-C0lR-2-7.js"], "css": ["/assets/route-D3qy7m5X.css", "/assets/meta-DdulKb1r.css", "/assets/heading-UwcgqAqE.css", "/assets/list-A5E2UkK_.css", "/assets/project-C8oXv4p4.css", "/assets/image-Db9mAJ2F.css"] }, "routes/$": { "id": "routes/$", "parentId": "root", "path": "*", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/_-CXlk1G04.js", "imports": ["/assets/jsx-runtime-e9svsKL-.js", "/assets/error-yYWAaizB.js", "/assets/components-C18L6ojx.js", "/assets/heading-Dsf1s-Cf.js", "/assets/decoder-text-BYPAtVqV.js", "/assets/visually-hidden-y2O2nUag.js", "/assets/use-spring-9URyKdiH.js", "/assets/index-tPt4D6iO.js", "/assets/image-CH7BK92V.js"], "css": ["/assets/error-BT7XG2_u.css", "/assets/heading-UwcgqAqE.css", "/assets/decoder-text-9RaPT1ab.css", "/assets/visually-hidden-BpS8kiyk.css", "/assets/image-Db9mAJ2F.css"] }, "routes/home/route": { "id": "routes/home/route", "parentId": "root", "path": "/", "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-1hSRzWWB.js", "imports": ["/assets/route-zL8O1YgO.js", "/assets/jsx-runtime-e9svsKL-.js", "/assets/slice-app-C7u_2Rr3.js", "/assets/meta-wLrhBEuU.js", "/assets/heading-Dsf1s-Cf.js", "/assets/components-C18L6ojx.js", "/assets/config-BuEQexaM.js", "/assets/preload-helper-D7HrI6pR.js", "/assets/decoder-text-BYPAtVqV.js", "/assets/visually-hidden-y2O2nUag.js", "/assets/use-spring-9URyKdiH.js", "/assets/index-tPt4D6iO.js", "/assets/image-CH7BK92V.js", "/assets/useScrollToHash-C31C6Ygo.js", "/assets/divider-CwASCwMq.js", "/assets/useWindowSize-BaU--EEd.js"], "css": ["/assets/route-B21ryf_9.css", "/assets/meta-DdulKb1r.css", "/assets/heading-UwcgqAqE.css", "/assets/decoder-text-9RaPT1ab.css", "/assets/visually-hidden-BpS8kiyk.css", "/assets/image-Db9mAJ2F.css", "/assets/divider-RCNywGVV.css"] } }, "url": "/assets/manifest-c0a7a082.js", "version": "c0a7a082" };
